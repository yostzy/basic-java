 ...
 * @author yosef
 */
public class hitam2 extends javax.swing.JFrame {

    /**
     * Creates new form ContohMethod
     */
    public ContohMethod() {                                               //akhir class dataSiswa
...
JOptionPane.showMessageDialog(null,"kerca pakus.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContohMethod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ContohMethod().setVisible(true);
            }
        });
    }
